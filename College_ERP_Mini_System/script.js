const config = {
  project: 'College ERP Mini System',
  entity: 'Student',
  plural: 'Students',
  fields: ['Name','Department','Semester'],
  statuses: ['Active','On leave','Alumni'],
  metric: 'Active students',
  storageKey: 'College_ERP_Mini_System_records',
  userKey: 'College_ERP_Mini_System_users',
  sessionKey: 'College_ERP_Mini_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Tina', field2: 'CSE', field3: '4', status: 'Active', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Raj', field2: 'ECE', field3: '6', status: 'On leave', owner: 'admin@example.com' }
];
