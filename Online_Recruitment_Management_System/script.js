const config = {
  entity: 'Applicant',
  plural: 'Applicants',
  fields: ['Candidate','Role','Score'],
  statuses: ['Applied','Interview','Hired'],
  metric: 'Hiring score',
  storageKey: 'Online_Recruitment_Management_System_records',
  userKey: 'Online_Recruitment_Management_System_users',
  sessionKey: 'Online_Recruitment_Management_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Nisha', field2: 'Frontend Dev', field3: '82', status: 'Interview', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Arjun', field2: 'QA Tester', field3: '76', status: 'Applied', owner: 'admin@example.com' }
];
