const config = {
  project: 'Online Course Marketplace',
  entity: 'Course',
  plural: 'Courses',
  fields: ['Title','Creator','Price'],
  statuses: ['Review','Live','Retired'],
  metric: 'Course value',
  storageKey: 'Online_Course_Marketplace_records',
  userKey: 'Online_Course_Marketplace_users',
  sessionKey: 'Online_Course_Marketplace_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Excel Basics', field2: 'Anjali', field3: '499', status: 'Live', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Python Start', field2: 'Rohan', field3: '799', status: 'Review', owner: 'admin@example.com' }
];
