const config = {
  ...
  entity: 'Trip',
  plural: 'Trips',
  fields: ['Traveler','Destination','Cost'],
  statuses: ['Planned','Booked','Completed'],
  metric: 'Booked cost',
  storageKey: 'Online_Travel_Booking_System_records',
  userKey: 'Online_Travel_Booking_System_users',
  sessionKey: 'Online_Travel_Booking_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Diya', field2: 'Goa', field3: '12000', status: 'Booked', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Harsh', field2: 'Jaipur', field3: '8000', status: 'Planned', owner: 'admin@example.com' }
];
