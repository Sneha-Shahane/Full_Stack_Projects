const config = {
  project: 'Online Freelancer Marketplace',
  entity: 'Gig',
  plural: 'Gigs',
  fields: ['Service','Freelancer','Budget'],
  statuses: ['Available','Hired','Paused'],
  metric: 'Available gigs',
  storageKey: 'Online_Freelancer_Marketplace_records',
  userKey: 'Online_Freelancer_Marketplace_users',
  sessionKey: 'Online_Freelancer_Marketplace_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Logo Design', field2: 'Nora', field3: '3000', status: 'Available', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'API Fix', field2: 'Kunal', field3: '7000', status: 'Hired', owner: 'admin@example.com' }
];
