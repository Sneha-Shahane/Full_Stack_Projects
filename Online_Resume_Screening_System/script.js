const config = {
  project: 'Online Resume Screening System',
  entity: 'Resume',
  plural: 'Resumes',
  fields: ['Candidate','Skill','Score'],
  statuses: ['New','Shortlisted','Rejected'],
  metric: 'Shortlisted',
  storageKey: 'Online_Resume_Screening_System_records',
  userKey: 'Online_Resume_Screening_System_users',
  sessionKey: 'Online_Resume_Screening_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Anya', field2: 'C#', field3: '82', status: 'Shortlisted', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Zubin', field2: 'SQL', field3: '68', status: 'New', owner: 'admin@example.com' }
];
