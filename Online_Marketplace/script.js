const config = {
  ...
  entity: 'Listing',
  plural: 'Listings',
  fields: ['Product','Seller','Price'],
  statuses: ['Active','Paused','Sold'],
  metric: 'Active listings',
  storageKey: 'Online_Marketplace_records',
  userKey: 'Online_Marketplace_users',
  sessionKey: 'Online_Marketplace_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Desk Lamp', field2: 'HomeKart', field3: '950', status: 'Active', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Cycle', field2: 'RideMore', field3: '6500', status: 'Paused', owner: 'admin@example.com' }
];
