const config = {
  ...
  entity: 'Exam',
  plural: 'Exams',
  fields: ['Subject','Duration','Marks'],
  statuses: ['Draft','Live','Closed'],
  metric: 'Average marks',
  storageKey: 'Online_Examination_System_records',
  userKey: 'Online_Examination_System_users',
  sessionKey: 'Online_Examination_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'C# Basics', field2: '45 min', field3: '50', status: 'Live', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Web Fundamentals', field2: '60 min', field3: '75', status: 'Draft', owner: 'admin@example.com' }
];
