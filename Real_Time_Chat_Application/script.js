const config = {
  ...
  entity: 'Room',
  plural: 'Rooms',
  fields: ['Room','Moderator','Topic'],
  statuses: ['Open','Muted','Closed'],
  metric: 'Open rooms',
  storageKey: 'Real_Time_Chat_Application_records',
  userKey: 'Real_Time_Chat_Application_users',
  sessionKey: 'Real_Time_Chat_Application_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'General', field2: 'Nita', field3: 'Introductions', status: 'Open', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Support', field2: 'Dev', field3: 'Account help', status: 'Muted', owner: 'admin@example.com' }
];
