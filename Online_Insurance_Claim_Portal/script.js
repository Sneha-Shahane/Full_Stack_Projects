const config = {
  entity: 'Claim',
  plural: 'Claims',
  fields: ['Policy Holder','Claim Type','Amount'],
  statuses: ['Submitted','Review','Approved'],
  metric: 'Approved amount',
  storageKey: 'Online_Insurance_Claim_Portal_records',
  userKey: 'Online_Insurance_Claim_Portal_users',
  sessionKey: 'Online_Insurance_Claim_Portal_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Ravi', field2: 'Health', field3: '18000', status: 'Review', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Maya', field2: 'Vehicle', field3: '32000', status: 'Approved', owner: 'admin@example.com' }
];
