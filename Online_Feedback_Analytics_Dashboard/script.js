const config = {
  project: 'Online Feedback Analytics Dashboard',
  entity: 'Feedback',
  plural: 'Feedback Items',
  fields: ['Customer','Channel','Rating'],
  statuses: ['New','Analyzed','Escalated'],
  metric: 'Average rating',
  storageKey: 'Online_Feedback_Analytics_Dashboard_records',
  userKey: 'Online_Feedback_Analytics_Dashboard_users',
  sessionKey: 'Online_Feedback_Analytics_Dashboard_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Asha', field2: 'Email', field3: '5', status: 'Analyzed', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Ravi', field2: 'Chat', field3: '3', status: 'New', owner: 'admin@example.com' }
];
