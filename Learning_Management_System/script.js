const config = {
  ...
  entity: 'Lesson',
  plural: 'Lessons',
  fields: ['Course','Instructor','Level'],
  statuses: ['Planned','Published','Archived'],
  metric: 'Published lessons',
  storageKey: 'Learning_Management_System_records',
  userKey: 'Learning_Management_System_users',
  sessionKey: 'Learning_Management_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'JavaScript', field2: 'Asha', field3: 'Beginner', status: 'Published', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Databases', field2: 'Ravi', field3: 'Intermediate', status: 'Planned', owner: 'admin@example.com' }
];
