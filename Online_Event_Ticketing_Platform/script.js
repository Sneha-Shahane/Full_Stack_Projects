const config = {
  project: 'Online Event Ticketing Platform',
  entity: 'Ticket',
  plural: 'Tickets',
  fields: ['Event','Buyer','Price'],
  statuses: ['Available','Booked','Cancelled'],
  metric: 'Booked value',
  storageKey: 'Online_Event_Ticketing_Platform_records',
  userKey: 'Online_Event_Ticketing_Platform_users',
  sessionKey: 'Online_Event_Ticketing_Platform_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Music Fest', field2: 'Asha', field3: '1200', status: 'Booked', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Tech Expo', field2: 'Ravi', field3: '500', status: 'Available', owner: 'admin@example.com' }
];
