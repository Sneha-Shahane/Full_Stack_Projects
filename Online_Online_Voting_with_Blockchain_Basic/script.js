const config = {
  entity: 'Block Vote',
  plural: 'Block Votes',
  fields: ['Voter','Candidate','Block No'],
  statuses: ['Pending','Verified','Rejected'],
  metric: 'Verified blocks',
  storageKey: 'Online_Online_Voting_with_Blockchain_Basic_records',
  userKey: 'Online_Online_Voting_with_Blockchain_Basic_users',
  sessionKey: 'Online_Online_Voting_with_Blockchain_Basic_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'VTR-101', field2: 'Alice', field3: '1', status: 'Verified', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'VTR-102', field2: 'Bob', field3: '2', status: 'Pending', owner: 'admin@example.com' }
];
