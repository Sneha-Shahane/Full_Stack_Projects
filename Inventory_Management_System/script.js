const config = {
  ...
  statuses: ['Available','Reorder','Discontinued'],
  metric: 'Total units',
  storageKey: 'Inventory_Management_System_records',
  userKey: 'Inventory_Management_System_users',
  sessionKey: 'Inventory_Management_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Laptop Stand', field2: 'LS-10', field3: '22', status: 'Available', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'USB Cable', field2: 'UC-2', field3: '5', status: 'Reorder', owner: 'admin@example.com' }
];
