const config = {
  project: 'Online NGO Management System',
  entity: 'Program',
  plural: 'Programs',
  fields: ['Program','Coordinator','Budget'],
  statuses: ['Planning','Running','Closed'],
  metric: 'Running budget',
  storageKey: 'Online_NGO_Management_System_records',
  userKey: 'Online_NGO_Management_System_users',
  sessionKey: 'Online_NGO_Management_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Food Drive', field2: 'Sara', field3: '30000', status: 'Running', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Books Camp', field2: 'Imran', field3: '15000', status: 'Planning', owner: 'admin@example.com' }
];
