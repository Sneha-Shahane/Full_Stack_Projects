const config = {
  entity: 'Comparison',
  plural: 'Comparisons',
  fields: ['Product A','Product B','Score'],
  statuses: ['Draft','Published','Archived'],
  metric: 'Average score',
  storageKey: 'Online_Product_Comparison_Website_records',
  userKey: 'Online_Product_Comparison_Website_users',
  sessionKey: 'Online_Product_Comparison_Website_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Phone X', field2: 'Phone Y', field3: '88', status: 'Published', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Laptop A', field2: 'Laptop B', field3: '74', status: 'Draft', owner: 'admin@example.com' }
];
