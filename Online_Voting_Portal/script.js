const config = {
  project: 'Online Voting Portal',
  entity: 'Candidate',
  plural: 'Candidates',
  fields: ['Name','Party','Votes'],
  statuses: ['Active','Leading','Withdrawn'],
  metric: 'Total votes',
  storageKey: 'Online_Voting_Portal_records',
  userKey: 'Online_Voting_Portal_users',
  sessionKey: 'Online_Voting_Portal_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Alice', field2: 'Blue', field3: '120', status: 'Leading', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Bob', field2: 'Green', field3: '90', status: 'Active', owner: 'admin@example.com' }
];
