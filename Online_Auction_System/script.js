const config = {
  ...
  entity: 'Auction',
  plural: 'Auctions',
  fields: ['Item','Seller','Bid'],
  statuses: ['Open','Closing','Sold'],
  metric: 'Highest bids',
  storageKey: 'Online_Auction_System_records',
  userKey: 'Online_Auction_System_users',
  sessionKey: 'Online_Auction_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Antique Clock', field2: 'Ritu', field3: '4500', status: 'Open', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Camera', field2: 'Naveen', field3: '9000', status: 'Closing', owner: 'admin@example.com' }
];
