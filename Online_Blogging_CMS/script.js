const config = {
  project: 'Online Blogging CMS',
  entity: 'Article',
  plural: 'Articles',
  fields: ['Title','Editor','Views'],
  statuses: ['Draft','Published','Archived'],
  metric: 'Total views',
  storageKey: 'Online_Blogging_CMS_records',
  userKey: 'Online_Blogging_CMS_users',
  sessionKey: 'Online_Blogging_CMS_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'SEO Tips', field2: 'Nita', field3: '350', status: 'Published', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'CMS Guide', field2: 'Dev', field3: '120', status: 'Draft', owner: 'admin@example.com' }
];
