const config = {
  entity: 'Parking Slot',
  plural: 'Parking Slots',
  fields: ['Slot','Vehicle','Fee'],
  statuses: ['Free','Reserved','Occupied'],
  metric: 'Occupied revenue',
  storageKey: 'Online_Smart_Parking_System_records',
  userKey: 'Online_Smart_Parking_System_users',
  sessionKey: 'Online_Smart_Parking_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'A-12', field2: 'MH12AB1234', field3: '80', status: 'Occupied', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'B-04', field2: 'Available', field3: '0', status: 'Free', owner: 'admin@example.com' }
];
