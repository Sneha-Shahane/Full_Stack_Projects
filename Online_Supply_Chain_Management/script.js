const config = {
  entity: 'Shipment',
  plural: 'Shipments',
  fields: ['Supplier','Route','Cost'],
  statuses: ['Packed','In transit','Delivered'],
  metric: 'Transit cost',
  storageKey: 'Online_Supply_Chain_Management_records',
  userKey: 'Online_Supply_Chain_Management_users',
  sessionKey: 'Online_Supply_Chain_Management_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'FreshFarm', field2: 'Pune-Mumbai', field3: '4500', status: 'In transit', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'TechParts', field2: 'Delhi-Jaipur', field3: '3200', status: 'Packed', owner: 'admin@example.com' }
];
