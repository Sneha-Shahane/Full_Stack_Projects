const config = {
  project: 'Online Customer Support Chatbot',
  entity: 'Query',
  plural: 'Queries',
  fields: ['Customer','Question','Intent'],
  statuses: ['Queued','Answered','Escalated'],
  metric: 'Answered queries',
  storageKey: 'Online_Customer_Support_Chatbot_records',
  userKey: 'Online_Customer_Support_Chatbot_users',
  sessionKey: 'Online_Customer_Support_Chatbot_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Ritu', field2: 'Where is my order?', field3: 'Tracking', status: 'Answered', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Naveen', field2: 'Need refund', field3: 'Refund', status: 'Escalated', owner: 'admin@example.com' }
];
