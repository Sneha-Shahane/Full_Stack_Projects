const config = {
  project: 'Online Recipe Sharing Platform',
  entity: 'Recipe',
  plural: 'Recipes',
  fields: ['Dish','Chef','Time'],
  statuses: ['Draft','Shared','Featured'],
  metric: 'Shared recipes',
  storageKey: 'Online_Recipe_Sharing_Platform_records',
  userKey: 'Online_Recipe_Sharing_Platform_users',
  sessionKey: 'Online_Recipe_Sharing_Platform_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Pasta', field2: 'Maya', field3: '25 min', status: 'Shared', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Poha', field2: 'Arun', field3: '15 min', status: 'Featured', owner: 'admin@example.com' }
];
