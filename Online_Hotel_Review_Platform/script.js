const config = {
  project: 'Online Hotel Review Platform',
  entity: 'Review',
  plural: 'Reviews',
  fields: ['Hotel','Guest','Rating'],
  statuses: ['Pending','Approved','Rejected'],
  metric: 'Average rating',
  storageKey: 'Online_Hotel_Review_Platform_records',
  userKey: 'Online_Hotel_Review_Platform_users',
  sessionKey: 'Online_Hotel_Review_Platform_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Lake Inn', field2: 'Pooja', field3: '5', status: 'Approved', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'City Stay', field2: 'Amit', field3: '3', status: 'Pending', owner: 'admin@example.com' }
];
