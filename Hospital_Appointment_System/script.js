const config = {
  ...
  statuses: ['Waiting','Confirmed','Completed'],
  metric: 'Confirmed visits',
  storageKey: 'Hospital_Appointment_System_records',
  userKey: 'Hospital_Appointment_System_users',
  sessionKey: 'Hospital_Appointment_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Anu', field2: 'Dr. Rao', field3: '10:30', status: 'Confirmed', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Vikram', field2: 'Dr. Sen', field3: '12:00', status: 'Waiting', owner: 'admin@example.com' }
];
