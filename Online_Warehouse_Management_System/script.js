const config = {
  entity: 'Bin',
  plural: 'Bins',
  fields: ['Bin','Item','Quantity'],
  statuses: ['Available','Low','Full'],
  metric: 'Total quantity',
  storageKey: 'Online_Warehouse_Management_System_records',
  userKey: 'Online_Warehouse_Management_System_users',
  sessionKey: 'Online_Warehouse_Management_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'W-12', field2: 'Keyboards', field3: '45', status: 'Available', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'W-18', field2: 'Adapters', field3: '6', status: 'Low', owner: 'admin@example.com' }
];
