const config = {
  ...
  entity: 'Booking',
  plural: 'Bookings',
  fields: ['Guest','Room','Nights'],
  statuses: ['Pending','Confirmed','Checked out'],
  metric: 'Booked nights',
  storageKey: 'Online_Hotel_Booking_System_records',
  userKey: 'Online_Hotel_Booking_System_users',
  sessionKey: 'Online_Hotel_Booking_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Kiran', field2: 'Deluxe', field3: '3', status: 'Confirmed', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Sara', field2: 'Suite', field3: '2', status: 'Pending', owner: 'admin@example.com' }
];
