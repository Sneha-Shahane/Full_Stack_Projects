const config = {
  entity: 'Tenant',
  plural: 'Tenants',
  fields: ['Company','Plan','MRR'],
  statuses: ['Trial','Active','Churned'],
  metric: 'Active MRR',
  storageKey: 'Online_SaaS_Subscription_Platform_records',
  userKey: 'Online_SaaS_Subscription_Platform_users',
  sessionKey: 'Online_SaaS_Subscription_Platform_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Nova Apps', field2: 'Pro', field3: '4999', status: 'Active', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Solo CRM', field2: 'Starter', field3: '999', status: 'Trial', owner: 'admin@example.com' }
];
