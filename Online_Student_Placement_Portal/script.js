const config = {
  entity: 'Placement',
  plural: 'Placements',
  fields: ['Student','Company','Package'],
  statuses: ['Applied','Selected','Rejected'],
  metric: 'Selected package',
  storageKey: 'Online_Student_Placement_Portal_records',
  userKey: 'Online_Student_Placement_Portal_users',
  sessionKey: 'Online_Student_Placement_Portal_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Pooja', field2: 'Infosys', field3: '450000', status: 'Selected', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Amit', field2: 'TCS', field3: '380000', status: 'Applied', owner: 'admin@example.com' }
];
