const config = {
  ...
  storageKey: 'Online_Blogging_Platform_records',
  userKey: 'Online_Blogging_Platform_users',
  sessionKey: 'Online_Blogging_Platform_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Learning CSS', field2: 'Mira', field3: 'Frontend', status: 'Published', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'My Startup Notes', field2: 'Kabir', field3: 'Business', status: 'Draft', owner: 'admin@example.com' }
];
