const config = {
  ...
  metric: 'Paid amount',
  storageKey: 'Online_Invoice_Generation_System_records',
  userKey: 'Online_Invoice_Generation_System_users',
  sessionKey: 'Online_Invoice_Generation_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Pixel Co', field2: 'Website', field3: '18000', status: 'Sent', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Bright Ltd', field2: 'SEO', field3: '12000', status: 'Paid', owner: 'admin@example.com' }
];
