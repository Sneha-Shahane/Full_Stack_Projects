const config = {
  project: 'Food Delivery Tracking System',
  entity: 'Delivery',
  plural: 'Deliveries',
  fields: ['Order','Rider','ETA'],
  statuses: ['Packed','On route','Delivered'],
  metric: 'On route',
  storageKey: 'Food_Delivery_Tracking_System_records',
  userKey: 'Food_Delivery_Tracking_System_users',
  sessionKey: 'Food_Delivery_Tracking_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'ORD101', field2: 'Ramesh', field3: '18 min', status: 'On route', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'ORD102', field2: 'Seema', field3: '5 min', status: 'Packed', owner: 'admin@example.com' }
];
