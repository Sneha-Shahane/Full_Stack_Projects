const config = {
  ...
  statuses: ['Normal','High','Flagged'],
  metric: 'Activity count',
  storageKey: 'Online_User_Activity_Tracker_records',
  userKey: 'Online_User_Activity_Tracker_users',
  sessionKey: 'Online_User_Activity_Tracker_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'admin@example.com', field2: 'Login', field3: '12', status: 'Normal', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'user@example.com', field2: 'Downloads', field3: '35', status: 'High', owner: 'admin@example.com' }
];
