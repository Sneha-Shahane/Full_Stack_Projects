const config = {
  project: 'Online Bug Tracking System',
  entity: 'Bug',
  plural: 'Bugs',
  fields: ['Title','Reporter','Priority'],
  statuses: ['Open','Fixing','Closed'],
  metric: 'Open bugs',
  storageKey: 'Online_Bug_Tracking_System_records',
  userKey: 'Online_Bug_Tracking_System_users',
  sessionKey: 'Online_Bug_Tracking_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Login crash', field2: 'QA Team', field3: 'High', status: 'Open', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Typo', field2: 'User', field3: 'Low', status: 'Fixing', owner: 'admin@example.com' }
];
