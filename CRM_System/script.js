const config = {
  ...
  entity: 'Lead',
  plural: 'Leads',
  fields: ['Client','Company','Value'],
  statuses: ['New','Contacted','Won'],
  metric: 'Pipeline value',
  storageKey: 'CRM_System_records',
  userKey: 'CRM_System_users',
  sessionKey: 'CRM_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Priya', field2: 'BrightTech', field3: '50000', status: 'Contacted', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Omar', field2: 'ScaleHub', field3: '90000', status: 'New', owner: 'admin@example.com' }
];
