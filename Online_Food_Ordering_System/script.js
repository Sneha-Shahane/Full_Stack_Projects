const config = {
  ...
  entity: 'Order',
  plural: 'Orders',
  fields: ['Customer','Meal','Total'],
  statuses: ['Preparing','Out for delivery','Delivered'],
  metric: 'Revenue',
  storageKey: 'Online_Food_Ordering_System_records',
  userKey: 'Online_Food_Ordering_System_users',
  sessionKey: 'Online_Food_Ordering_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Maya', field2: 'Paneer Bowl', field3: '320', status: 'Preparing', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Arun', field2: 'Veg Burger', field3: '180', status: 'Delivered', owner: 'admin@example.com' }
];
