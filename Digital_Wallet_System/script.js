const config = {
  ...
  metric: 'Successful amount',
  storageKey: 'Digital_Wallet_System_records',
  userKey: 'Digital_Wallet_System_users',
  sessionKey: 'Digital_Wallet_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Asha', field2: 'Topup', field3: '1000', status: 'Success', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Ravi', field2: 'Transfer', field3: '250', status: 'Pending', owner: 'admin@example.com' }
];
