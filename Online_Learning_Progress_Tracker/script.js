const config = {
  project: 'Online Learning Progress Tracker',
  entity: 'Progress',
  plural: 'Progress Items',
  fields: ['Learner','Course','Percent'],
  statuses: ['Not started','Learning','Completed'],
  metric: 'Completed items',
  storageKey: 'Online_Learning_Progress_Tracker_records',
  userKey: 'Online_Learning_Progress_Tracker_users',
  sessionKey: 'Online_Learning_Progress_Tracker_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Meena', field2: 'C#', field3: '75', status: 'Learning', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Arun', field2: 'HTML', field3: '100', status: 'Completed', owner: 'admin@example.com' }
];
