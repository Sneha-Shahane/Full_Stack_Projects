const config = {
  project: 'Online Inventory Billing System',
  entity: 'Invoice',
  plural: 'Invoices',
  fields: ['Customer','Item','Amount'],
  statuses: ['Draft','Paid','Overdue'],
  metric: 'Paid amount',
  storageKey: 'Online_Inventory_Billing_System_records',
  userKey: 'Online_Inventory_Billing_System_users',
  sessionKey: 'Online_Inventory_Billing_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Apex Ltd', field2: 'Printer', field3: '8500', status: 'Paid', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Nova Co', field2: 'Paper', field3: '1200', status: 'Draft', owner: 'admin@example.com' }
];
