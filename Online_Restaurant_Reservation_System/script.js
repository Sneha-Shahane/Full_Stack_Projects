const config = {
  entity: 'Reservation',
  plural: 'Reservations',
  fields: ['Guest','Table','Guests'],
  statuses: ['Requested','Confirmed','Cancelled'],
  metric: 'Confirmed guests',
  storageKey: 'Online_Restaurant_Reservation_System_records',
  userKey: 'Online_Restaurant_Reservation_System_users',
  sessionKey: 'Online_Restaurant_Reservation_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Meera', field2: 'T4', field3: '4', status: 'Confirmed', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Kabir', field2: 'T2', field3: '2', status: 'Requested', owner: 'admin@example.com' }
];
