const config = {
  project: 'Online Real Estate Listing Platform',
  entity: 'Property',
  plural: 'Properties',
  fields: ['Title','Location','Price'],
  statuses: ['Available','Negotiating','Sold'],
  metric: 'Listed value',
  storageKey: 'Online_Real_Estate_Listing_Platform_records',
  userKey: 'Online_Real_Estate_Listing_Platform_users',
  sessionKey: 'Online_Real_Estate_Listing_Platform_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: '2BHK Apartment', field2: 'Pune', field3: '6500000', status: 'Available', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Office Space', field2: 'Mumbai', field3: '12000000', status: 'Negotiating', owner: 'admin@example.com' }
];
