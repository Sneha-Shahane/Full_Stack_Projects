const config = {
  ...
  entity: 'Show',
  plural: 'Shows',
  fields: ['Movie','Screen','Seats'],
  statuses: ['Booking','Almost full','Closed'],
  metric: 'Seats listed',
  storageKey: 'Online_Movie_Ticket_Booking_records',
  userKey: 'Online_Movie_Ticket_Booking_users',
  sessionKey: 'Online_Movie_Ticket_Booking_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Space Quest', field2: 'Screen 1', field3: '80', status: 'Booking', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'City Lights', field2: 'Screen 2', field3: '18', status: 'Almost full', owner: 'admin@example.com' }
];
