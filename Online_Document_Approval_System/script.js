const config = {
  project: 'Online Document Approval System',
  entity: 'Document',
  plural: 'Documents',
  fields: ['Title','Owner','Version'],
  statuses: ['Draft','Approved','Rejected'],
  metric: 'Approved docs',
  storageKey: 'Online_Document_Approval_System_records',
  userKey: 'Online_Document_Approval_System_users',
  sessionKey: 'Online_Document_Approval_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Policy Update', field2: 'HR', field3: 'v2', status: 'Approved', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Vendor Form', field2: 'Ops', field3: 'v1', status: 'Draft', owner: 'admin@example.com' }
];
