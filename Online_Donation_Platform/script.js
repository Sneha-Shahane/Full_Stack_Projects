const config = {
  project: 'Online Donation Platform',
  entity: 'Campaign',
  plural: 'Campaigns',
  fields: ['Cause','Organizer','Goal'],
  statuses: ['Collecting','Funded','Closed'],
  metric: 'Goal amount',
  storageKey: 'Online_Donation_Platform_records',
  userKey: 'Online_Donation_Platform_users',
  sessionKey: 'Online_Donation_Platform_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'School Kits', field2: 'Hope NGO', field3: '25000', status: 'Collecting', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Tree Drive', field2: 'Green Club', field3: '10000', status: 'Funded', owner: 'admin@example.com' }
];
