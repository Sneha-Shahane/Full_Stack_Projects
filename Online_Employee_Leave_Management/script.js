const config = {
  project: 'Online Employee Leave Management',
  entity: 'Leave',
  plural: 'Leaves',
  fields: ['Employee','Type','Days'],
  statuses: ['Applied','Approved','Rejected'],
  metric: 'Approved days',
  storageKey: 'Online_Employee_Leave_Management_records',
  userKey: 'Online_Employee_Leave_Management_users',
  sessionKey: 'Online_Employee_Leave_Management_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Nita', field2: 'Casual', field3: '2', status: 'Approved', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Dev', field2: 'Sick', field3: '1', status: 'Applied', owner: 'admin@example.com' }
];
