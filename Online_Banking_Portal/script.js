const config = {
  project: 'Online Banking Portal',
  entity: 'Account',
  plural: 'Accounts',
  fields: ['Holder','Account No','Balance'],
  statuses: ['Active','Frozen','Closed'],
  metric: 'Total balance',
  storageKey: 'Online_Banking_Portal_records',
  userKey: 'Online_Banking_Portal_users',
  sessionKey: 'Online_Banking_Portal_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Meena', field2: '10021', field3: '15000', status: 'Active', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Amit', field2: '10022', field3: '9000', status: 'Frozen', owner: 'admin@example.com' }
];
