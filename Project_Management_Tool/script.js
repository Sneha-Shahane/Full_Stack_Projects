const config = {
  ...
  entity: 'Task',
  plural: 'Tasks',
  fields: ['Title','Owner','Sprint'],
  statuses: ['Todo','Doing','Done'],
  metric: 'Done tasks',
  storageKey: 'Project_Management_Tool_records',
  userKey: 'Project_Management_Tool_users',
  sessionKey: 'Project_Management_Tool_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Build login', field2: 'Sara', field3: 'Sprint 1', status: 'Doing', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Fix navbar', field2: 'Imran', field3: 'Sprint 1', status: 'Todo', owner: 'admin@example.com' }
];
