const config = {
  project: 'ECommerce Website with Cart',
  entity: 'Product',
  plural: 'Products',
  fields: ['Name','Category','Price'],
  statuses: ['In stock','Low stock','Sold out'],
  metric: 'Catalog value',
  storageKey: 'ECommerce_Website_with_Cart_records',
  userKey: 'ECommerce_Website_with_Cart_users',
  sessionKey: 'ECommerce_Website_with_Cart_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Wireless Mouse', field2: 'Accessories', field3: '799', status: 'In stock', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Backpack', field2: 'Travel', field3: '1499', status: 'Low stock', owner: 'admin@example.com' }
];
