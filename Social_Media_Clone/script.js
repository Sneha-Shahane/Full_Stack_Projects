const config = {
  ...
  entity: 'Post',
  plural: 'Posts',
  fields: ['Author','Caption','Likes'],
  statuses: ['Public','Friends','Archived'],
  metric: 'Total likes',
  storageKey: 'Social_Media_Clone_records',
  userKey: 'Social_Media_Clone_users',
  sessionKey: 'Social_Media_Clone_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Riya', field2: 'Sunset walk', field3: '45', status: 'Public', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Dev', field2: 'Launch day', field3: '88', status: 'Friends', owner: 'admin@example.com' }
];
