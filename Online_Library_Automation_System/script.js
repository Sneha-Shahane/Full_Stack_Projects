const config = {
  entity: 'Book',
  plural: 'Books',
  fields: ['Title','Member','Days'],
  statuses: ['Available','Issued','Overdue'],
  metric: 'Issued days',
  storageKey: 'Online_Library_Automation_System_records',
  userKey: 'Online_Library_Automation_System_users',
  sessionKey: 'Online_Library_Automation_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Clean Code', field2: 'Riya', field3: '7', status: 'Issued', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'C# Guide', field2: 'None', field3: '0', status: 'Available', owner: 'admin@example.com' }
];
