const config = {
  project: 'Online Code Submission Platform',
  entity: 'Submission',
  plural: 'Submissions',
  fields: ['Student','Problem','Score'],
  statuses: ['Submitted','Passed','Failed'],
  metric: 'Passed submissions',
  storageKey: 'Online_Code_Submission_Platform_records',
  userKey: 'Online_Code_Submission_Platform_users',
  sessionKey: 'Online_Code_Submission_Platform_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Karan', field2: 'Arrays', field3: '90', status: 'Passed', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Riya', field2: 'Loops', field3: '45', status: 'Submitted', owner: 'admin@example.com' }
];
