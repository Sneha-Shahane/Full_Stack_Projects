const config = {
  project: 'Online Interview Scheduling System',
  entity: 'Interview',
  plural: 'Interviews',
  fields: ['Candidate','Panel','Slot'],
  statuses: ['Scheduled','Rescheduled','Done'],
  metric: 'Scheduled calls',
  storageKey: 'Online_Interview_Scheduling_System_records',
  userKey: 'Online_Interview_Scheduling_System_users',
  sessionKey: 'Online_Interview_Scheduling_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Farah', field2: 'Frontend', field3: '11:00', status: 'Scheduled', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Nilesh', field2: 'Backend', field3: '15:00', status: 'Rescheduled', owner: 'admin@example.com' }
];
