const config = {
  project: 'Online Music Streaming App',
  entity: 'Track',
  plural: 'Tracks',
  fields: ['Song','Artist','Plays'],
  statuses: ['Draft','Published','Removed'],
  metric: 'Total plays',
  storageKey: 'Online_Music_Streaming_App_records',
  userKey: 'Online_Music_Streaming_App_users',
  sessionKey: 'Online_Music_Streaming_App_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Skyline', field2: 'Nora', field3: '1200', status: 'Published', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Night Ride', field2: 'Kunal', field3: '650', status: 'Draft', owner: 'admin@example.com' }
];
