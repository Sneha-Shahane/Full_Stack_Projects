const config = {
  entity: 'File',
  plural: 'Files',
  fields: ['File Name','Owner','Size MB'],
  statuses: ['Private','Shared','Archived'],
  metric: 'Stored MB',
  storageKey: 'Online_Cloud_File_Storage_System_records',
  userKey: 'Online_Cloud_File_Storage_System_users',
  sessionKey: 'Online_Cloud_File_Storage_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'resume.pdf', field2: 'Asha', field3: '2', status: 'Private', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'project.zip', field2: 'Team', field3: '45', status: 'Shared', owner: 'admin@example.com' }
];
