const config = {
  ...
  fields: ['Customer','Plan','Amount'],
  statuses: ['Trial','Active','Cancelled'],
  metric: 'Monthly value',
  storageKey: 'Subscription_Management_System_records',
  userKey: 'Subscription_Management_System_users',
  sessionKey: 'Subscription_Management_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Bright Co', field2: 'Pro', field3: '1999', status: 'Active', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Solo Dev', field2: 'Starter', field3: '499', status: 'Trial', owner: 'admin@example.com' }
];
