const config = {
  ...
  statuses: ['Open','Interviewing','Closed'],
  metric: 'Open jobs',
  storageKey: 'Job_Portal_Website_records',
  userKey: 'Job_Portal_Website_users',
  sessionKey: 'Job_Portal_Website_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Junior Developer', field2: 'CodeWorks', field3: 'Remote', status: 'Open', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'QA Intern', field2: 'TestLab', field3: 'Pune', status: 'Interviewing', owner: 'admin@example.com' }
];
