const config = {
  entity: 'Candidate',
  plural: 'Candidates',
  fields: ['Name','Region','Votes'],
  statuses: ['Active','Leading','Closed'],
  metric: 'Total votes',
  storageKey: 'Online_Digital_Voting_Dashboard_records',
  userKey: 'Online_Digital_Voting_Dashboard_users',
  sessionKey: 'Online_Digital_Voting_Dashboard_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Anita Rao', field2: 'North', field3: '340', status: 'Leading', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Rahul Mehta', field2: 'South', field3: '280', status: 'Active', owner: 'admin@example.com' }
];
