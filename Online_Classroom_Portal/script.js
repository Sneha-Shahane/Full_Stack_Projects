const config = {
  project: 'Online Classroom Portal',
  entity: 'Class',
  plural: 'Classes',
  fields: ['Subject','Teacher','Room'],
  statuses: ['Scheduled','Live','Completed'],
  metric: 'Live classes',
  storageKey: 'Online_Classroom_Portal_records',
  userKey: 'Online_Classroom_Portal_users',
  sessionKey: 'Online_Classroom_Portal_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Math', field2: 'Dr. Sen', field3: 'A101', status: 'Scheduled', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Science', field2: 'Dr. Rao', field3: 'Lab 2', status: 'Live', owner: 'admin@example.com' }
];
