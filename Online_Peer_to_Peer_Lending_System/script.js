const config = {
  entity: 'Loan',
  plural: 'Loans',
  fields: ['Borrower','Purpose','Amount'],
  statuses: ['Requested','Funded','Repaid'],
  metric: 'Funded amount',
  storageKey: 'Online_Peer_to_Peer_Lending_System_records',
  userKey: 'Online_Peer_to_Peer_Lending_System_users',
  sessionKey: 'Online_Peer_to_Peer_Lending_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Isha', field2: 'Education', field3: '25000', status: 'Funded', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Mohan', field2: 'Business', field3: '40000', status: 'Requested', owner: 'admin@example.com' }
];
