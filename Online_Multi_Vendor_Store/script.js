const config = {
  entity: 'Vendor Product',
  plural: 'Vendor Products',
  fields: ['Product','Vendor','Price'],
  statuses: ['Pending','Live','Suspended'],
  metric: 'Live value',
  storageKey: 'Online_Multi_Vendor_Store_records',
  userKey: 'Online_Multi_Vendor_Store_users',
  sessionKey: 'Online_Multi_Vendor_Store_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Cotton Shirt', field2: 'StyleHub', field3: '899', status: 'Live', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Desk Mat', field2: 'WorkKart', field3: '599', status: 'Pending', owner: 'admin@example.com' }
];
