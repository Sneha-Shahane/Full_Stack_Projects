const config = {
  project: 'Online Meeting Room Booking',
  entity: 'Room Booking',
  plural: 'Room Bookings',
  fields: ['Team','Room','Time'],
  statuses: ['Requested','Approved','Cancelled'],
  metric: 'Approved rooms',
  storageKey: 'Online_Meeting_Room_Booking_records',
  userKey: 'Online_Meeting_Room_Booking_users',
  sessionKey: 'Online_Meeting_Room_Booking_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Design', field2: 'Orion', field3: '14:00', status: 'Approved', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Sales', field2: 'Nova', field3: '16:00', status: 'Requested', owner: 'admin@example.com' }
];
