const config = {
  project: 'Online Helpdesk Ticketing System',
  entity: 'Ticket',
  plural: 'Tickets',
  fields: ['Subject','Agent','Priority'],
  statuses: ['New','Assigned','Resolved'],
  metric: 'Resolved tickets',
  storageKey: 'Online_Helpdesk_Ticketing_System_records',
  userKey: 'Online_Helpdesk_Ticketing_System_users',
  sessionKey: 'Online_Helpdesk_Ticketing_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Cannot login', field2: 'Mira', field3: 'High', status: 'Assigned', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Refund query', field2: 'Kabir', field3: 'Medium', status: 'New', owner: 'admin@example.com' }
];
