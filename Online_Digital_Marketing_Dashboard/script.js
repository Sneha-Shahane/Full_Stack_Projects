const config = {
  entity: 'Campaign',
  plural: 'Campaigns',
  fields: ['Campaign','Channel','Clicks'],
  statuses: ['Draft','Running','Paused'],
  metric: 'Total clicks',
  storageKey: 'Online_Digital_Marketing_Dashboard_records',
  userKey: 'Online_Digital_Marketing_Dashboard_users',
  sessionKey: 'Online_Digital_Marketing_Dashboard_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Festive Sale', field2: 'Instagram', field3: '1200', status: 'Running', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Lead Ads', field2: 'Google', field3: '850', status: 'Paused', owner: 'admin@example.com' }
];
