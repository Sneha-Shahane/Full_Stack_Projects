const config = {
  project: 'Online Taxi Booking System',
  entity: 'Ride',
  plural: 'Rides',
  fields: ['Rider','Pickup','Fare'],
  statuses: ['Requested','Assigned','Completed'],
  metric: 'Completed fares',
  storageKey: 'Online_Taxi_Booking_System_records',
  userKey: 'Online_Taxi_Booking_System_users',
  sessionKey: 'Online_Taxi_Booking_System_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Isha', field2: 'Station', field3: '220', status: 'Assigned', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Mohan', field2: 'Airport', field3: '750', status: 'Requested', owner: 'admin@example.com' }
];
