const config = {
  entity: 'Time Entry',
  plural: 'Time Entries',
  fields: ['Project','Freelancer','Hours'],
  statuses: ['Running','Submitted','Approved'],
  metric: 'Approved hours',
  storageKey: 'Online_Freelance_Time_Tracker_records',
  userKey: 'Online_Freelance_Time_Tracker_users',
  sessionKey: 'Online_Freelance_Time_Tracker_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Logo Set', field2: 'Nora', field3: '6', status: 'Submitted', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'API Fix', field2: 'Kunal', field3: '4', status: 'Approved', owner: 'admin@example.com' }
];
