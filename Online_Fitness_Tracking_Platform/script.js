const config = {
  project: 'Online Fitness Tracking Platform',
  entity: 'Workout',
  plural: 'Workouts',
  fields: ['User','Activity','Minutes'],
  statuses: ['Planned','Done','Skipped'],
  metric: 'Workout minutes',
  storageKey: 'Online_Fitness_Tracking_Platform_records',
  userKey: 'Online_Fitness_Tracking_Platform_users',
  sessionKey: 'Online_Fitness_Tracking_Platform_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'Pooja', field2: 'Yoga', field3: '30', status: 'Done', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'Amit', field2: 'Cycling', field3: '45', status: 'Planned', owner: 'admin@example.com' }
];
