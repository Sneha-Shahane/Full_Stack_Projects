const config = {
  project: 'Online Stock Portfolio Tracker',
  entity: 'Holding',
  plural: 'Holdings',
  fields: ['Symbol','Company','Value'],
  statuses: ['Watch','Holding','Sold'],
  metric: 'Portfolio value',
  storageKey: 'Online_Stock_Portfolio_Tracker_records',
  userKey: 'Online_Stock_Portfolio_Tracker_users',
  sessionKey: 'Online_Stock_Portfolio_Tracker_session'
};

const seedItems = [
    { id: crypto.randomUUID(), field1: 'TCS', field2: 'Tata Consultancy', field3: '15000', status: 'Holding', owner: 'admin@example.com' },
    { id: crypto.randomUUID(), field1: 'INFY', field2: 'Infosys', field3: '9000', status: 'Watch', owner: 'admin@example.com' }
];
